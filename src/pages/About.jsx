    ...
    <div>
      <section className="relative bg-navy-radial text-cream py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          <p className="font-accent italic text-gold-300 text-xl mb-2">About Us</p>
          <h1 className="text-5xl font-bold mb-4">We Are My Mayon</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="bg-navy-800 rounded-2xl p-6 text-center">
