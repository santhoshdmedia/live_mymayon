      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative min-h-[420px] sm:min-h-[380px]">
            {slides.map((s, i) => (
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-navy-800 mt-4 mb-5 leading-[1.08]">
                  <TitleWithHighlight title={s.title} highlight={s.highlight} />
                </h1>

                {s.subtitle && (
                  <p className="text-lg text-navy-500 mb-6 leading-relaxed max-w-lg">
                    {s.subtitle}
                  </p>
                )}
                ...
                {s.ctaText && s.ctaLink && (
                  <Link
                    to={s.ctaLink}
                    className="inline-flex items-center gap-2 text-navy-800 font-semibold mb-6 hover:text-gold-600 transition-colors group"
                  >
                    {s.ctaText}
            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-navy-900/10 p-6 space-y-4 border border-navy-100 relative z-10 mt-2">
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap gap-5 mt-6 relative z-10">
              ...
              <div className="flex items-center gap-4 mt-6 relative z-10">
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  <button type="button" onClick={prev} aria-label="Previous slide"
                    className="w-8 h-8 flex items-center justify-center rounded-full border border-navy-200 text-navy-500 hover:border-gold-400 hover:text-gold-600 transition-colors cursor-pointer">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full bg-gold-400 relative flex items-center justify-center shadow-2xl shadow-gold-500/30 overflow-hidden">
              {slides.map((s, i) => (
                <img
                  key={s._id || i}
            ...
            <div className="absolute -top-2 right-4 sm:right-0 w-14 h-14 bg-[#0B9B8A] rounded-full flex items-center justify-center shadow-lg ring-2 ring-white">
              <MapPin className="w-6 h-6 text-white" />
            </div>

            {/* Gold plane (top-left) */}
            <div className="absolute top-10 -left-2 sm:-left-6 w-10 h-10 rounded-full border-2 border-gold-500 flex items-center justify-center text-gold-500 bg-white shadow">
            ...
            <div className="absolute top-1/2 -right-2 sm:-right-6 -translate-y-1/2 w-12 h-12 bg-[#0B9B8A] rounded-full flex items-center justify-center shadow-lg ring-2 ring-white">
            ...
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-12 h-12 bg-gold-500 rounded-full flex items-center justify-center shadow-lg ring-2 ring-white">
              <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white" xmlns="http://www.w3.org/2000/svg">
